package Beat_Generating_System;

/**
 * Created by Umang on 10-12-2016.
 */
import java.awt.*;
import javax.swing.*;
...
public class BeatBoxUltimate {  // implements MetaEventListener
    ...
    public void buildGUI() {
        ...
        JButton Restore = new JButton("Restore your Beat!!");
        ...
        theFrame.setBounds(50,50,767,380);
        theFrame.pack();
...
//============================================================== inner class listeners
    ...
    public class MySaveListener implements ActionListener {    // new - save
        public void actionPerformed(ActionEvent a) {
            ...
            int g=-1;
            String name=JOptionPane.showInputDialog("Name your Sequence!");

//            final int i1 = JOptionPane.showConfirmDialog("Thank You");
    ...
    public class MyReadInListener implements ActionListener {
        private java.lang.Object infoMessage;  // new - restore
        public void actionPerformed(ActionEvent a) {
            // read in the thing
            ...
            try {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(null,infoMessage, "File not Found", JOptionPane.INFORMATION_MESSAGE);
                }
    ...
    public class MySendListener implements ActionListener {    // new - save
        public void actionPerformed(ActionEvent a) {
            ...
            try {
                ...
                ex.printStackTrace();
                userMessage.setText("sorry dude. Could not send it to the server");
            }
